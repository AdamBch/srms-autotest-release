...
from variables import rel_master_admin_email 
from variables import rel_master_admin_password 
...
master_admin_email = rel_master_admin_email
master_admin_password = rel_master_admin_password
...
def test_port_creation_process_rel(browser):
    ...
    actions.move_to_element(create_port_button).perform()
    ...
    delete_button = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-operators/div/section/section/app-ports/div/section/section/app-scroll-table/div/div/table/tbody/tr[1]/td[6]/div/span/button/mat-icon")
    delete_button.click()
    time.sleep(1)
