...
def test_vessel_creation_process_rel(browser):
    ...
    create_vessel_button = browser.find_element(By.XPATH, "/html/body/app-root/app-default-layout/div/div/section/app-operators/div/section/section/app-vessels/div/div/button/span[1]")
